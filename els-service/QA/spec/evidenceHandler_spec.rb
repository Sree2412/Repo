...
describe 'EELS services functionality for EvidenceHandler entity' do
  context 'making a GET request for EvidenceHandler' do
    before {
      @get_call = @eels_auth.get('EvidenceHandler')
    }
