...
ClusterName = 'Sri_env'
CampusCode = 'DEV'
Chef_Environment = 'qa_env'
Chef_Server = 'https://chef.consilio.com/organizations/consilio-dev'
With_Driver = 'vra:https://cloud.consilio.com'
AttachedDrive = 'F:'
RELSETUPONLY = 0
SkipStep = 1

### Set Which Machine Batch will runt ###
    ...
    if p_sql == 1 || all == 1
      ...
      if sqlnodes == 1
        ...
        machine "#{ClusterName}-sql" do
          ...
          attribute %w(Relativity Install PrimaryInstance), lazy {sql_search.call[0]['hostname']}
          attribute %w(Relativity SQLPrimary FileRepo), lazy {"\\\\#{sql_search.call[0]['fqdn']}\\FileShare"}
          attribute %w(Relativity SQLPrimary EDDSFileShare), lazy {"\\\\#{sql_search.call[0]['fqdn']}\\EDDSFileShare"}
          attribute %w(Relativity SQLPrimary DTSearch), lazy {"\\\\#{sql_search.call[0]['fqdn']}\\DTSearch"}
