...
# Databag Credentials
Rel_ServiceAcct = Chef::EncryptedDataBagItem.load('serviceaccounts', 'relativity_test-serviceaccountpassword', 'consiliopass123')['username']
Rel_ServiceAcct_Password = Chef::EncryptedDataBagItem.load('serviceaccounts', 'relativity_test-serviceaccountpassword', 'consiliopass123')['password']
SQL_ServiceAcct = Chef::EncryptedDataBagItem.load('serviceaccounts', 'relativity_test-serviceaccountpassword', 'consiliopass123')['username']
SQL_ServiceAcct_Password = Chef::EncryptedDataBagItem.load('serviceaccounts', 'relativity_test-serviceaccountpassword', 'consiliopass123')['password']
EDDSDBOPassword = Chef::EncryptedDataBagItem.load('serviceaccounts', 'relativity_test-eddsdbopassword', 'consiliopass123')['password']
