...
public class Performance_Scaling_StageIngestionTest extends BaseTest{	
			
	String threadCount;
		
	@Parameters("count")
	public Performance_Scaling_StageIngestionTest(String thCount) {
	...
	public void ingestions(String testCaseName, String destinationFileToCompare, String areaId, String conName, String conType, String dbName) throws Exception{		
